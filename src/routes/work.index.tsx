        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-6">
          {PROJECTS.map((p, i) => (
            ...
            >
              ...
              >
                <CosmicCard interactive className="p-8 md:p-10 h-full">
                  <div className="pointer-events-none absolute -top-32 -right-32 w-72 h-72 rounded-full bg-primary/15 blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" aria-hidden="true" />
